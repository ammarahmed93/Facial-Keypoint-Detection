...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # 64 input image channel (grayscale), 128 output channels/feature maps, 5x5 square convolution kernel
        ...
        # 64 input image channel (grayscale), 256 output channels/feature maps, 5x5 square convolution kernel
